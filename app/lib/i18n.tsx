...
export const STRINGS: Dict = {
  ...
  "song.evenly": { en: "This one came in as a file, so its words are spread evenly over its length rather than laid on the music.", af: "Hierdie een het as \u2019n l\u00eaer ingekom, so sy woorde word gelykop oor sy lengte versprei eerder as op die musiek gel\u00ea." },
