...
export const STRINGS: Dict = {
  ...
  "hero.make": { en: "Make your own music.", af: "Maak jou eie musiek." },
  "hero.record": {
    en: "Professional recordings of your own voice.",
    af: "Professionele opnames van jou eie stem.",
  },
  "hero.video": { en: "Make music videos.", af: "Maak musiekvideo\u2019s." },
  "hero.style": {
