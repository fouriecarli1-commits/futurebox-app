...
export const STRINGS: Dict = {
  ...
  "pay.openNote": { en: "Opens your 15-second preview into the full song. The watermark stays.", af: "Maak jou voorsmakie van 15 sekondes oop na die hele snit. Die watermerk bly." },
  "pay.keep": { en: "Keep it, clean", af: "Hou dit, skoon" },
  "pay.keepNote": { en: "No watermark, downloadable, and the rights are yours. Opening first costs you nothing extra.", af: "Geen watermerk, aflaaibaar, en die regte is joune. Om eers oop te maak kos jou niks ekstra nie." },
