...
export const STRINGS: Dict = {
  ...
  "sec.whatFor": { en: "This is where a song is edited and made again: move its sections, repeat one, take one out, then send it back to be regenerated with the changes in it.", af: "Hier word ’n liedjie geredigeer en weer gemaak: skuif sy dele rond, herhaal een, haal een uit, en stuur dit dan terug sodat dit met die veranderinge oorgemaak word." },
