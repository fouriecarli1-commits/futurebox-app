...
export const STRINGS: Dict = {
  ...
  "train.where": { en: "Training a singing voice is what Kits.AI is for, and your plan pays for it. This app cannot hand your takes over yet — that part is still to be built here — so for now the takes go up at kits.ai and you bring the model’s number back.", af: "Om ’n sangstem op te lei is juis waarvoor Kits.AI daar is, en jou plan betaal daarvoor. Hierdie toep kan jou opnames nog nie self oorhandig nie — daardie deel moet hier gebou word — so vir eers gaan die opnames by kits.ai op en jy bring die model se nommer terug." },
