...
export const STRINGS: Dict = {
  ...
  "train.where": { en: "The training itself happens at kits.ai — this app sings in a voice that already exists. Take your recordings there, then bring the model’s number back here.", af: "Die oplei self gebeur by kits.ai — hierdie toep sing in ’n stem wat reeds bestaan. Vat jou opnames daarheen, en bring dan die model se nommer hierheen terug." },
