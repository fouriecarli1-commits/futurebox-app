...
export const STRINGS: Dict = {
  ...
  "chan.videosNote": { en: "Kept on this device, like your songs. Download one to post it anywhere — nothing here is published until you say so.", af: "Op hierdie toestel gehou, net soos jou liedjies. Laai een af om dit enige plek te plaas — niks hier word gepubliseer voordat jy so sê nie." },
  ...
  "from.link": { en: "A link reads the song\u2019s name off YouTube, Spotify, SoundCloud, Apple Music or TikTok and works the style out from that. It does not listen to it \u2014 downloading from those sites is against their rules, so this reads what the song is called, not how it sounds.", af: "\u2019n Skakel lees die liedjie se naam van YouTube, Spotify, SoundCloud, Apple Music of TikTok af en werk die styl daaruit uit. Dit luister nie daarna nie \u2014 om van daardie webwerwe af te laai is teen hulle re\u00ebls, so dit lees wat die liedjie heet, nie hoe dit klink nie." },
  "link.paste": { en: "Paste a song link", af: "Plak \u2019n liedjie se skakel" },
  "link.read": { en: "Read the style off it", af: "Lees die styl daarvan af" },
  "link.failed": { en: "That link could not be read.", af: "Daardie skakel kon nie gelees word nie." },
  "link.knew": { en: "recognised", af: "herken" },
  "link.guessed": { en: "not recognised \u2014 read off the title alone", af: "nie herken nie \u2014 net van die titel af gelees" },
