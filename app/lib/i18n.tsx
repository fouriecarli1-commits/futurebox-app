...
export const STRINGS: Dict = {
  ...
  "pro.singModelHelp": { en: "The number of a voice model on your kits.ai account — it is in the address bar when you open one there. It is remembered on this device.", af: "Die nommer van ’n stemmodel op jou kits.ai-rekening — dit staan in die adresbalk wanneer jy een daar oopmaak. Dit word op hierdie toestel onthou." },
