...
export const STRINGS: Dict = {
  ...
  "radar.topic": { en: "Topic (e.g. Build a track from a comment prompt)", af: "Onderwerp (bv. Bou ’n snit uit ’n kommentaar)" },
  ...
  "pro.readUnknown": { en: "It read the song, but nothing in the answer was a tempo, a key or a list of chords. That is a workflow that returns something else.", af: "Dit het die snit gelees, maar niks in die antwoord was ’n tempo, ’n toonsoort of ’n lys akkoorde nie. Dit is ’n werkvloei wat iets anders teruggee." },
  ...
  "pics.why": { en: "PNG, JPEG or WebP, up to 4 MB. It is kept here so the next clip can use the same one — which is the only way two clips share a face, a room or a product.", af: "PNG, JPEG of WebP, tot 4 MB. Dit word hier gehou sodat die volgende snit dieselfde een kan gebruik — wat die enigste manier is waarop twee snitte dieselfde gesig, kamer of produk deel." },
  ...
  "board.makeAllFirst": { en: "Every shot needs a clip before it can be cut.", af: "Elke skoot het ’n snit nodig voor dit gesny kan word." },
