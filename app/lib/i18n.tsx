...
export const STRINGS: Dict = {
  ...
  "pics.why": { en: "PNG, JPEG or WebP, up to 4 MB. It is kept here so the next clip can use the same one — which is the only way two clips share a face, a room or a product.", af: "PNG, JPEG of WebP, tot 4 MB. Dit word hier gehou sodat die volgende liedjie dieselfde een kan gebruik — wat die enigste manier is waarop twee liedjies dieselfde gesig, kamer of produk deel." },
  ...
  "frame.hint": { en: "The shape of the clip comes from the picture now. Write what moves rather than what it looks like.", af: "Die vorm van die liedjie kom nou van die prent af. Skryf wat beweeg eerder as hoe dit lyk." },
  "frame.why": { en: "Optional, and it costs nothing extra. A picture settles the look in one go \u2014 the same face, the same room, the same product in every clip \u2014 so the sentence only has to say what moves.", af: "Opsioneel, en dit kos niks ekstra nie. \u2019n Prent besleg die voorkoms in een slag \u2014 dieselfde gesig, dieselfde kamer, dieselfde produk in elke liedjie \u2014 sodat die sin net hoef te s\u00ea wat beweeg." },
  ...
  "video.sub": { en: "Pick one of your songs. The video is made right here, on this page \u2014 then you decide whether to save it or share it.", af: "Kies een van jou liedjies. Die video word hier op die blad gemaak \u2014 dan besluit jy of jy dit hou of stuur." },
  "video.pick": { en: "Which song?", af: "Watter liedjie?" },
  "video.none": { en: "Make a song first \u2014 then it can become a video.", af: "Maak eers ’n liedjie \u2014 dan kan dit ’n video word." },
  ...
  "pres.whyRead": { en: "Reading it costs a fraction of the video. Hearing the words in that voice before the picture is made is the difference between one clip and three.", af: "Om dit te lees kos ’n breukdeel van die video. Om die woorde in daardie stem te hoor voordat die prent gemaak word, is die verskil tussen een liedjie en drie." },
  ...
  "safe.cropped": { en: "This clip is not the shape these apps play. Posted there it is shown in the marked column and the sides are cropped off \u2014 before anything is printed on top.", af: "Hierdie liedjie is nie die vorm wat hierdie programme speel nie. Daar geplaas, word dit in die gemerkte kolom gewys en die kante word afgesny \u2014 nog voordat enigiets bo-op gedruk word." },
  ...
  "board.blurNote": { en: "The space around a shot is filled with a blurred, enlarged copy of that shot. Nothing is cropped \u2014 the clip itself is drawn whole, on top.", af: "Die ruimte rondom \u2019n opname word gevul met \u2019n vervaagde, vergrote kopie van daardie opname. Niks word afgesny nie \u2014 die liedjie self word heel bo-op geteken." },
  ...
  "board.makeAllFirst": { en: "Every shot needs a clip before it can be cut.", af: "Elke skoot het ’n liedjie nodig voor dit gesny kan word." },
  ...
  "board.lost": { en: "A shot\u2019s clip is no longer on this device. Make that one again before cutting.", af: "’n Skoot se liedjie is nie meer op hierdie toestel nie. Maak daardie een weer voor jy sny." },
