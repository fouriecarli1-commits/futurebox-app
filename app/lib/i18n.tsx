...
export const STRINGS: Dict = {
  ...
  "chan.noOwner": { en: "This app has no owner set, so nobody may use its name \u2014 not even you. The owner address has not been put on this deployment yet; it is one setting, and the going-live notes name it.", af: "Hierdie app het geen eienaar gestel nie, so niemand mag sy naam gebruik nie \u2014 ook nie jy nie. Die eienaar se adres is nog nie op hierdie ontplooiing gesit nie; dit is een instelling, en die going-live notas noem dit." },
  ...
  "hooks.bringWhy": { en: "A song or a video you have on this device. A video is cut with the sound that is on it, and the moments are found in that sound. Nothing can be taken from YouTube or another site \u2014 their terms do not allow it, and this app will not pretend otherwise.", af: "\u2019n Liedjie of \u2019n video wat jy op hierdie toestel het. \u2019n Video word gesny met die klank wat daarop is, en die oomblikke word in daardie klank gevind. Niks kan van YouTube of \u2019n ander werf gevat word nie \u2014 hulle voorwaardes laat dit nie toe nie, en hierdie app gaan nie anders voorgee nie." },
  ...
  "song.byEar": { en: "The words are laid on the singing this app measured in the song.", af: "Die woorde l\u00ea op die sang wat hierdie app in die liedjie gemeet het." },
  ...
  "invite.why": { en: "The room only exists once two people have agreed, so somebody who does not have an account cannot be reached from here. This link lands them on the app, survives them signing up, and turns into a request from you with your reason already on it.", af: "Die kamer bestaan eers wanneer twee mense ingestem het, so iemand sonder \u2019n rekening kan nie van hier af bereik word nie. Hierdie skakel laat hulle op die app land, oorleef hulle registrasie, en word \u2019n versoek van jou af met jou rede reeds daarop." },
  ...
  "invite.unknown": { en: "That link is not one this app knows.", af: "Daardie skakel is nie een wat hierdie app ken nie." },
