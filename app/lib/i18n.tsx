...
export const STRINGS: Dict = {
  ...
  "pod.episodeNote": { en: "Record it here, or use something a voice read. Publishing puts the audio at a public address that podcast apps keep fetching.", af: "Neem dit hier op, of gebruik iets wat \u2019n stem gelees het. Publiseer sit die klank by \u2019n publieke adres wat potgooi-toeps aanhou aflaai." },
