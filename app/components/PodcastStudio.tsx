          ...
          <div className="rounded-xl border border-zinc-800 bg-zinc-900/60 p-3 space-y-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="min-h-[44px] px-2.5 py-1.5 rounded-lg bg-zinc-950 border border-zinc-700 text-zinc-300 text-sm flex items-center gap-1.5 flex-shrink-0"
              >
            ...
            <div className="flex flex-wrap gap-1.5 pt-0.5">
              {(['x', 'whatsapp', 'facebook', 'linkedin'] as const).map((where) => (
                <button
                  ...
                  type="button"
                  onClick={() => share(where)}
                  className="min-h-[44px] px-2.5 py-1.5 rounded-lg bg-zinc-950 border border-zinc-700 text-zinc-300 text-sm hover:border-cyan-500 hover:text-cyan-300 flex items-center gap-1.5"
                >
        ...
        <div className="flex flex-wrap gap-2">
          {recording ? (
            <button
              ...
              className="min-h-[44px] px-3.5 py-2.5 rounded-xl bg-red-500/20 border border-red-500 text-red-300 text-sm font-semibold flex items-center gap-1.5"
            >
                ...
                <div className="flex items-center justify-between gap-3">
                  ...
                  <div className="flex items-center gap-1 flex-shrink-0">
                    ...
                    <button
                      ...
                      className={`min-h-[44px] inline-flex items-center gap-1.5 rounded-lg border px-2.5 py-1.5 text-xs font-semibold transition-colors ${
                        dubbing === episode.id
