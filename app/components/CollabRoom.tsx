          ...
          {waiting.map((one) => (
            ...
            <div className="flex gap-2">
                <button
                  ...
                  className="min-h-[44px] px-3 py-1.5 rounded-xl bg-emerald-500 text-onAccent text-sm font-bold flex items-center gap-1.5 disabled:opacity-50"
                >
                ...
                <button
                  ...
                  disabled={busy === one.id}
                  className="min-h-[44px] px-3 py-1.5 rounded-xl bg-zinc-900 border border-zinc-700 text-zinc-400 text-sm font-semibold disabled:opacity-50"
                >
          ...
          <div className="rounded-xl border border-zinc-800 bg-zinc-900/60 p-3 space-y-3">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="min-h-[44px] px-3 py-2 rounded-xl bg-emerald-500 text-onAccent disabled:opacity-50"
                ...
                <div className="flex flex-wrap gap-1.5">
                  {tracks.slice(0, 8).map((track) => (
                    <button
                      ...
                      disabled={busy === 'say'}
                      className="min-h-[44px] px-2.5 py-1 rounded-lg bg-zinc-950 border border-zinc-800 text-sm text-zinc-400 hover:border-emerald-500 hover:text-emerald-300 flex items-center gap-1.5 disabled:opacity-50"
                    >
